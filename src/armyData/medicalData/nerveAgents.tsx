  ...
  const topics = [
    {
      ...
      sections: [
        {
          question: "What are signs and symptoms of nerve agent exposure?",
          answer: [
        ...
        },
        {
          ...
          answer: [
            "An Antidote Treatment Nerve Agent Autoinjector (ATNAA) is used to treat mild nerve agent exposure.",
            "The injection site is the outer thigh and th
          ],
        },
        {
